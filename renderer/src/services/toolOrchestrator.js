/**
 * ZAI - Tool Orchestrator (local Qwen2.5 Coder as Project Manager)
 *
 ...
 * ZAI's plain {role, content} internal message format. llamaEngine.js's
...
import * as terminalTool from '../native-clients/terminalTool';
...
export async function runToolTask(userRequest, context = {}, onStep = null) {
  ...
  const systemPrompt = `You are ZAI's project manager. The person describes what they want in plain language; you decide which tool functions to call, in what order, to accomplish it - they should never need to name a specific function or press a button themselves.
