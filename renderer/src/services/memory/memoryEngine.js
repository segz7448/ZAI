/**
 * ZAI - Long-Term Memory Engine
 *
 * This gives ZAI the same kind of persistent, cross-conversation memory
 ...
 *      deterministic and immediate: if the person explicitly asks ZAI to
 *      remember or forget something, it must actually happen, synchronously,
 *      before ZAI even replies - not "maybe, if the background extraction
...
// if the person explicitly asks ZAI to remember or forget something, that
 ...
 *
 * Returns a short confirmation string ZAI can use as/prepend to its reply,
...
export async function buildMemoryContextBlock() {
  ...
  return (
    `The following are things you (ZAI) remember about the person from past conversations. ` +
 ...
 * @param {string} assistantText - ZAI's reply this turn
